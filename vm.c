...
// --- MEMORY MANAGEMENT ---
void track_alloc(void *ptr, uint32_t sid, uint32_t size, int is_stack, char *comment)
{
...
void abyss_eye()
{
    ...
    printf(C_BOLD C_CYAN "  "
                         "╭────────────────────────────────────────────────────────────────────"
                         "──────────────────────────────────────────╮\n" C_RESET);
    printf(C_BOLD C_CYAN "  │" C_RESET C_BOLD
    ...
    printf(C_BOLD C_CYAN "  │" C_RESET "  Active Heap Memory  : " C_BOLD C_YELLOW
                         ...
                         "                " C_BOLD C_CYAN "│\n" C_RESET,
           active_heap);
    printf(C_BOLD C_CYAN "  │" C_RESET "  Total Memory Freed  : " C_BOLD C_GRAY "%-8u bytes" C_RESET
                         "                                                       "
                         "                " C_BOLD C_CYAN "│\n" C_RESET,
           total_freed);
    printf(C_BOLD C_CYAN "  │" C_RESET "  Total Allocations   : " C_BOLD "%-8u" C_RESET
                         "                                                       "
                         "                      " C_BOLD C_CYAN "│\n" C_RESET,
           total_allocs);
    printf(C_BOLD C_CYAN "  "
    ...
    printf(C_BOLD C_RED "  "
                        "├───────────────────┬───────┬──────────────┬────────────┬───────┬────"
                        "─────┬──────────────────────────────────┤\n" C_RESET);
    printf(C_BOLD C_RED "  │" C_RESET " ADDRESS           " C_BOLD C_RED "│" C_RESET
                        " BYTES " C_BOLD C_RED "│" C_RESET " TYPE         " C_BOLD C_RED "│" C_RESET
                        " VARIABLE   " C_BOLD C_RED "│" C_RESET " SCOPE " C_BOLD C_RED "│" C_RESET
                        " ORIGIN  " C_BOLD C_RED "│" C_RESET
    ...
    if (active_count == 0)
    {
        printf(C_BOLD C_RED "  │" C_RESET C_GRAY
    ...
    while (curr)
    {
        if (!curr->is_freed)
        {
            ...
            printf(C_BOLD C_RED "  │ " C_RESET "%s " C_BOLD C_CYAN "0x%012lx" C_RESET C_BOLD C_RED
                                ...
                                " │\n" C_RESET,
                   icon, (uintptr_t) curr->ptr, curr->size, type_name, tag_name, lifetime,
                   curr->alloc_ip, comment_str);
            printf(C_BOLD C_RED "  │                   │       │              │      "
                                "      │       │         │ " C_GREEN "%-32.32s" C_BOLD C_RED
                                " │\n" C_RESET,
                   hex_buf);
    ...
    printf(C_BOLD C_MAGENTA "  "
                            "╭────────────────────────────────────────────────────────────────────"
                            "──────────────────────────────────────────╮\n" C_RESET);
    printf(C_BOLD C_MAGENTA "  │" C_RESET C_BOLD
    ...
    printf(C_BOLD C_MAGENTA "  "
                            "├───────────────────┬───────┬──────────────┬────────────┬───────┬────"
                            "───────────┬────────────────────────────┤\n" C_RESET);
    printf(C_BOLD C_MAGENTA "  │" C_RESET " ADDRESS           " C_BOLD C_MAGENTA "│" C_RESET
                            " BYTES " C_BOLD C_MAGENTA "│" C_RESET " TYPE         " C_BOLD C_MAGENTA
                            "│" C_RESET " VARIABLE   " C_BOLD C_MAGENTA "│" C_RESET
                            " SCOPE " C_BOLD C_MAGENTA "│" C_RESET
                            " STATUS        " C_BOLD C_MAGENTA "│" C_RESET
    ...
    {
        const char *type_name = (curr->struct_id == 0xFFFFFFFF)   ? "Array"
                                : (curr->struct_id == 0xFFFFFFFE) ? "DynString"
                                                                  : structs[curr->struct_id].name;
        const char *tag_name = curr->tag ? curr->tag : "-";
        const char *lifetime = curr->is_stack ? "Stack" : "Heap";
        ...
        {
            printf(C_BOLD C_MAGENTA
                   "  │ " C_RESET C_CYAN "0x%012lx" C_RESET C_BOLD C_MAGENTA " │ " C_RESET
                   "%-5u" C_BOLD C_MAGENTA " │ " C_RESET "%-12.12s" C_BOLD C_MAGENTA " │ " C_RESET
                   "%-10.10s" C_BOLD C_MAGENTA " │ " C_RESET "%-5s" C_BOLD C_MAGENTA
                   " │ " C_BOLD C_GREEN "[OK] FREED   " C_RESET C_BOLD C_MAGENTA " │ " C_RESET
                   "IP:%04lX -> IP:%04lX      " C_BOLD C_MAGENTA " │\n" C_RESET,
                   (uintptr_t) curr->ptr, curr->size, type_name, tag_name, lifetime, curr->alloc_ip,
                   curr->free_ip);
        }
        else
        {
            printf(
                ...
                "  │ " C_RESET C_CYAN "0x%012lx" C_RESET C_BOLD C_MAGENTA " │ " C_RESET
                "%-5u" C_BOLD C_MAGENTA " │ " C_RESET "%-12.12s" C_BOLD C_MAGENTA " │ " C_RESET
                "%-10.10s" C_BOLD C_MAGENTA " │ " C_RESET "%-5s" C_BOLD C_MAGENTA " │ " C_BOLD C_RED
                "[!!] ACTIVE  " C_RESET C_BOLD C_MAGENTA " │ " C_RESET "IP:%04lX -> " C_YELLOW
